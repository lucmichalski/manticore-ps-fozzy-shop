    ...
    <div class="col-12 col-sm-6 col-md-6 product-line-grid-right product-line-actions">
        <div class="row align-items-center small-gutters justify-content-end">
            ...
            <div class="col col-auto col-md qty">
                {if isset($product.legend) && $product.legend == 'fozzy_gift'}
                    <span class="gift-quantity">{$product.quantity}</span>
                {else}
                    <a id="btn_change_pagecart_{$product.id}" 
                    ...
                    <input
                            style="display:none !impotant;"
                            class="js-cart-line-product-quantity"
                            data-down-url="{$product.down_quantity_url}&qty={$product.minimal_quantity}"
                            data-up-url="{$product.up_quantity_url}&qty={$product.minimal_quantity}"
