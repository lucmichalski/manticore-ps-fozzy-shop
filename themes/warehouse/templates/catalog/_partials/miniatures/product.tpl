...
{block name='product_miniature_item'}
    ...
    <div class="js-product-miniature-wrapper {if !$product.available_for_order}product_grey{/if} {if isset($carousel) && $carousel}product-carousel{else}
    {if isset($elementor) && $elementor}
    col-{$nbMobile} col-md-{$nbTablet} col-lg-{$nbDesktop} col-xl-{$nbDesktop}
    {else}
    col-{$iqitTheme.pl_grid_p} col-md-{$iqitTheme.pl_grid_t} {if $iqitTheme.pl_grid_d != 15} col-lg-{$iqitTheme.pl_grid_d} col-xl-{$iqitTheme.pl_grid_ld} {else}col-lg-3 col-xl-3{/if}{/if}
    {/if} ">
        <article
