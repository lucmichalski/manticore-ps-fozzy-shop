    ...
    <div class="box hidden-sm-down">
        <table id="order-products" class="table table-bordered">
            ...
            <tr>
                ...
                <th>{l s='Заказанное кол-во' d='Shop.Theme.Catalog'}</th>
            ...
            {foreach from=$order.products item=product}
                <tr>
                    ...
                    <td>
                        {foreach $order.order_cart_product as $order_cart_products}
                             {if $order_cart_products.id_product == $product.product_id}
                                {$order_cart_products.quantity}
                             {/if}
                    {/foreach}
                    </td>
                    <td>
            ...
            <div class="order-item">
                <div class="row">
                    <div class="col-sm-5 desc">
                        ...
                        {/if}
                        <div class="ref">{l s='Заказанное кол-во' d='Shop.Theme.Catalog'} - {foreach $order.order_cart_product as $order_cart_products}
                             {if $order_cart_products.id_product == $product.product_id}
                                {$order_cart_products.quantity}
                             {/if}
                    {/foreach}</div>
                    ...
                    <div class="col-sm-7 qty">
                        <div class="row">
                            <div class="col-12 text-sm-left text-xs-left">
                            {l s='Собрано:' d='Shop.Theme.Catalog'}
                            </div>
