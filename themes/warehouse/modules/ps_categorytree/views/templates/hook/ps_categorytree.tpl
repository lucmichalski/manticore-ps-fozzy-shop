...
<div id="backcat" class="modal-backdrop" style="z-index: 10;"></div>
  <div class="block block-toggle block-categories block-links js-block-toggle modal-cover" style="z-index: 100;">
