...
class HTMLTemplateDeliverySlipCore extends HTMLTemplate
{
    ...
    public function getContent()
    {
        ...
        $req_teml = 'delivery-slip-req'.$this->order->id_shop;

        switch ($delivery_address->zone) {
              case '4':  // Петровка
                $req_teml = 'delivery-slip-req25';
              break;
              case '5': //Заболотного
              case '5,6':
              case '4,5':
                $req_teml = 'delivery-slip-req1';
              break;
              case '6':  // Проліски
                $req_teml = 'delivery-slip-req30';
              break;
            }
        $this->smarty->assign(array(
            ...
            'delivery_address_true' => $delivery_address->company,
        ...
        $tpls = array(
            'req_tab' => $this->smarty->fetch($this->getTemplate($req_teml)),
