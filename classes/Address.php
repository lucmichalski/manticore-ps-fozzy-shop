...
class AddressCore extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'city' => array('type' => self::TYPE_STRING, 'validate' => 'isAddress', 'required' => true, 'size' => 255),
            'other' => array('type' => self::TYPE_STRING, 'validate' => 'isMessage', 'size' => 300),
            'phone' => array('type' => self::TYPE_STRING, 'validate' => 'isPhoneNumber', 'size' => 32),
            'phone_mobile' => array('type' => self::TYPE_STRING, 'validate' => 'isPhoneNumber', 'size' => 32),
            'dni' => array('type' => self::TYPE_STRING, 'validate' => 'isDniLite', 'size' => 16),
            'deleted' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool', 'copy_post' => false),
            'valid_adr' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool'),
            'is_dm' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool'),
            'street' => array('type' => self::TYPE_STRING, 'validate' => 'isAddress'),
            'house' => array('type' => self::TYPE_STRING, 'validate' => 'isAddress'),
            'apartment' => array('type' => self::TYPE_STRING, 'validate' => 'isAddress'),
            'level' => array('type' => self::TYPE_STRING, 'validate' => 'isAddress'),
            'door' => array('type' => self::TYPE_STRING, 'validate' => 'isAddress'),
            'intercom' => array('type' => self::TYPE_STRING, 'validate' => 'isAddress'),
            'elevator' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool'),
            'concierge' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool'),
            'zone' => array('type' => self::TYPE_STRING, 'validate' => 'isString'),
            'zone_name' => array('type' => self::TYPE_STRING, 'validate' => 'isString'),
