...
class OrderStateCore extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'tsd' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool'),
            'changes' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool'),
            'showinord' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool'),
            'window' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool'),
     ...
     */
    public static function getOrderStates($id_lang, $in_order = 0)
    {
            $sql_find = '
            SELECT *
            ...
            WHERE deleted = 0 ';
            if ($in_order == 1) $sql_find .= ' AND `showinord` = 1 ';
            $sql_find .= ' ORDER BY `name` ASC';
            $result = Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS($sql_find);
            return $result;
    }
