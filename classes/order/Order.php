...
class OrderCore extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
         ...
         //   'zone' => array('type' => self::TYPE_STRING),
         //   'zone_name' => array('type' => self::TYPE_STRING),
            'order_type' => array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
            'order_from' => array('type' => self::TYPE_INT),
        ),
    );
    ...
    public function getProductsDetail()
    {
        ...
        WHERE od.`id_order` = ' . (int) $this->id . ' ORDER BY od.`sorder`');
    }
