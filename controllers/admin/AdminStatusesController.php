...
class AdminStatusesControllerCore extends AdminController
{
    ...
    protected function initOrderStatutsList()
    {
        ...
        /*    'send_email' => array(
            ...
            'tsd' => array(
                'title' => $this->trans('Отправлять на ТСД', array(), 'Admin.Global'),
                'align' => 'text-center',
                'active' => 'tsd',
                'type' => 'bool',
                'ajax' => true,
            ...
            'showinord' => array(
                'title' => $this->trans('Показывать в заказе', array(), 'Admin.Global'),
                'align' => 'text-center',
                'active' => 'showinord',
                'type' => 'bool',
                'ajax' => true,
            ...
            'changes' => array(
                'title' => $this->trans('Разрешить изменения', array(), 'Admin.Global'),
                'align' => 'text-center',
                'active' => 'changes',
                'type' => 'bool',
                'ajax' => true,
            ...
            'window' => array(
                'title' => $this->trans('Расчет окон', array(), 'Admin.Global'),
                'align' => 'text-center',
                'active' => 'window',
                'type' => 'bool',
                'ajax' => true,
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'values' => array(
                        'query' => array(
                            array('id' => 'on', 'name' => $this->trans('Отправлять на ТСД', array(), 'Admin.Shopparameters.Feature'), 'val' => '1'),
                            ),
                        'id' => 'id',
                        'name' => 'name',
                    ),
                ...
                array(
                    ...
                    'values' => array(
                        'query' => array(
                            array('id' => 'on', 'name' => $this->trans('Разрешить изменения', array(), 'Admin.Shopparameters.Feature'), 'val' => '1'),
                            ),
                        'id' => 'id',
                        'name' => 'name',
                    ),
                ...
                array(
                    ...
                    'values' => array(
                        'query' => array(
                            array('id' => 'on', 'name' => $this->trans('Расчет окон доставки', array(), 'Admin.Shopparameters.Feature'), 'val' => '1'),
                            ),
                        'id' => 'id',
                        'name' => 'name',
                    ),
                ...
                array(
                    ...
                    'values' => array(
                        'query' => array(
                            array('id' => 'on', 'name' => $this->trans('Показывать в заказе', array(), 'Admin.Shopparameters.Feature'), 'val' => '1'),
                            ),
                        'id' => 'id',
                        'name' => 'name',
                    ),
    ...
    protected function renderOrderStatusForm()
    {
        ...
        $this->fields_value = array(
            ...
            'tsd_on' => $this->getFieldValue($obj, 'tsd'),
            'changes_on' => $this->getFieldValue($obj, 'changes'),
            'showinord_on' => $this->getFieldValue($obj, 'showinord'),
            'window_on' => $this->getFieldValue($obj, 'window'),
    ...
    public function postProcess()
    {
        ...
        if (Tools::isSubmit('submitAdd' . $this->table)) {
            ...
            $_POST['tsd'] = (int) Tools::getValue('tsd_on');
            $_POST['changes'] = (int) Tools::getValue('changes_on');
            $_POST['showinord'] = (int) Tools::getValue('showinord_on');
            $_POST['window'] = (int) Tools::getValue('window_on');
    ...
    public function ajaxProcessShowinordOrderState()
    {
        $id_order_state = (int) Tools::getValue('id_order_state');

        $sql = 'UPDATE ' . _DB_PREFIX_ . 'order_state SET `showinord`= NOT `showinord` WHERE id_order_state=' . $id_order_state;
        $result = Db::getInstance()->execute($sql);
    ...
    public function ajaxProcessTsdOrderState()
    {
        $id_order_state = (int) Tools::getValue('id_order_state');

        $sql = 'UPDATE ' . _DB_PREFIX_ . 'order_state SET `tsd`= NOT `tsd` WHERE id_order_state=' . $id_order_state;
        $result = Db::getInstance()->execute($sql);
    ...
    public function ajaxProcessChangesOrderState()
    {
        $id_order_state = (int) Tools::getValue('id_order_state');

        $sql = 'UPDATE ' . _DB_PREFIX_ . 'order_state SET `changes`= NOT `changes` WHERE id_order_state=' . $id_order_state;
        $result = Db::getInstance()->execute($sql);
    ...
    public function ajaxProcessWindowOrderState()
    {
        $id_order_state = (int) Tools::getValue('id_order_state');

        $sql = 'UPDATE ' . _DB_PREFIX_ . 'order_state SET `window`= NOT `window` WHERE id_order_state=' . $id_order_state;
        $result = Db::getInstance()->execute($sql);
