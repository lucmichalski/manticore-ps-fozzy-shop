    ...
    public function renderForm()
    {
        ...
        foreach ($addresses_fields as $addr_field_item) {
            if ($addr_field_item == 'company') {
                ...
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Улица', array(), 'Admin.Global'),
                    'name' => 'street',
                    'class' => 'adr_custom',
                    'col' => '6',
                    'required' => false,
                ...
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Дом', array(), 'Admin.Global'),
                    'name' => 'house',
                    'class' => 'adr_custom',
                    'col' => '6',
                    'required' => false,
                ...
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Широта', array(), 'Admin.Global'),
                    'name' => 'lat',
                    'class' => 'adr_custom',
                    'readonly' => true,
                    'col' => '3',
                ...
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Долгота', array(), 'Admin.Global'),
                    'name' => 'lng',
                    'class' => 'adr_custom',
                    'readonly' => true,
                    'col' => '3',
                ...
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Номер зоны геолокации', array(), 'Admin.Global'),
                    'name' => 'zone',
                    'class' => 'adr_custom',
                    'readonly' => true,
                    'col' => '3',
                ...
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Зона геолокации', array(), 'Admin.Global'),
                    'name' => 'zone_name',
                    'class' => 'adr_custom',
                    'readonly' => true,
                    'col' => '3',
                ...
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Квартира или офис', array(), 'Admin.Global'),
                    'name' => 'apartment',
                    'class' => 'adr_custom',
                    'col' => '6',
                    'required' => false,
                ...
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Этаж', array(), 'Admin.Global'),
                    'name' => 'level',
                    'class' => 'adr_custom',
                    'col' => '6',
                    'required' => false,
                ...
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Подъезд', array(), 'Admin.Global'),
                    'name' => 'door',
                    'class' => 'adr_custom',
                    'col' => '6',
                    'required' => false,
                ...
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Код домофона', array(), 'Admin.Global'),
                    'name' => 'intercom',
                    'class' => 'adr_custom',
                    'col' => '6',
                    'required' => false,
                ...
                $temp_fields[] = array(
                  					'type' => 'switch',
                  					'label' => $this->trans('Лифт', array(), 'Admin.Global'),
                  					'name' => 'elevator',
                            'class' => 'adr_custom',
                  					'is_bool' => true,
                  					'values' => array(
                ...
                $temp_fields[] = array(
                  					'type' => 'switch',
                  					'label' => $this->trans('Консьерж', array(), 'Admin.Global'),
                  					'name' => 'concierge',
                            'class' => 'adr_custom',
                  					'is_bool' => true,
                  					'values' => array(
                ...
                $temp_fields[] = array(
                  					'type' => 'switch',
                  					'label' => $this->trans('Адрес проверен', array(), 'Admin.Global'),
                  					'name' => 'valid_adr',
                            'class' => 'adr_custom',
                  					'is_bool' => true,
                         //   'disabled' => true,
                ...
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Строка адреса', array(), 'Admin.Global'),
                    'name' => 'address1',
                    'col' => '6',
                    'required' => true,
                    'readonly' => true,
                ...
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Версия клиента', array(), 'Admin.Global'),
                    'name' => 'address3',
                    'col' => '6',
                    'required' => false,
                    'readonly' => true,
