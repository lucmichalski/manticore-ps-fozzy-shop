...
$sql[] = 'DROP TABLE IF EXISTS `'._DB_PREFIX_.'fozzy_autoupdate`';
$sql[] = 'DROP TABLE IF EXISTS `'._DB_PREFIX_.'fozzy_autoupdate_online`';
$sql[] = "CREATE TABLE IF NOT EXISTS `"._DB_PREFIX_."fozzy_autoupdate` (
        ...
        `site_display` INT(1) NULL DEFAULT '1',                                                        
...
$sql[] = "CREATE TABLE `"._DB_PREFIX_."fozzy_autoupdate_online` (
          `id_online` INT NOT NULL AUTO_INCREMENT,
          `id_product` INT NULL,
          `reference` INT NULL,
          `price` DECIMAL(20,2) NULL,
          `price_retail` DECIMAL(20,2) NULL,
          `price_old` DECIMAL(20,2) NULL,
          `date_start` DATE NULL,
          `date_stop` DATE NULL,
          `factor` INT NOT NULL DEFAULT '0',
          PRIMARY KEY (`id_online`),
          INDEX `Prod` (`id_product`, `reference`)
          ) ENGINE ="._MYSQL_ENGINE_." DEFAULT CHARSET=utf8";
