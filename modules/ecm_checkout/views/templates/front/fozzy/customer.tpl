...
<div class="required form-row {$item}-block frr-50">
		<label class="">{l s='Login phone' mod='ecm_checkout'}</label>
    ...
    <label class="">{l s='Retry phone' mod='ecm_checkout'}</label>
...
{if !$ecm_customer->id}
  ...
  <input class="form-control pass_ontype {$item} {$item}_login  font-password {if Configuration::Get('ecm_checkout_password2')}check-50{/if}" {if $type_auth != "guest"}required="required"{/if}  autocomplete="off" title = "{l s='Password' mod='ecm_checkout'}" value="{$ecm_customer->password}" id="{$item}" type="text" act="save_login" placeholder="{l s='Password' mod='ecm_checkout'}"/>
	...
	{if Configuration::Get('ecm_checkout_password2')}
  <label class="">{l s='Retry password' mod='ecm_checkout'}</label>
...
<div class="form-row" {$as[$item]['unvisible']}>
        <label class="">{l s='Home phone' mod='ecm_checkout'}</label>
...
{$item = 'firstname'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='First name' mod='ecm_checkout'}</label> 
...
{$item = 'lastname'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Last name' mod='ecm_checkout'}</label> 
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
...
{$item = 'middlename'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Middle name' mod='ecm_checkout'}</label> 
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
...
{$item = 'company'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Company' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']}  {$as[$item]['unvisible']}
...
{$item = 'city'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='City' mod='ecm_checkout'}</label> 
...
<div class="form-row" {$as[$item]['unvisible']} >
        ...
        <label class="">{l s='Zip/Postal Cod' mod='ecm_checkout'}</label>
...
{$item = 'address2'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Address2' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
...
{$item = 'phone_mobile'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Mobile phone' mod='ecm_checkout'}</label>
        <input class="form-control  customer_ontype phone" {$as[$item]['required_input']}
...
{$item = 'street'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Street' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
		title="{l s='Street' mod='ecm_checkout'}" {$as[$item]['required']} placeholder="{l s='Street' mod='ecm_checkout'}"
        id="{$item}" name="{$item}" value="{$address->$item}" type="text" act="save_address">
</div>
{$item = 'house'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='House' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
		title="{l s='House' mod='ecm_checkout'}" {$as[$item]['required']} placeholder="{l s='House' mod='ecm_checkout'}"
        id="{$item}" name="{$item}" value="{$address->$item}" type="text" act="save_address">
</div>
{$item = 'apartment'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Apartment' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
		title="{l s='Apartment' mod='ecm_checkout'}" {$as[$item]['required']} placeholder="{l s='Apartment' mod='ecm_checkout'}"
        id="{$item}" name="{$item}" value="{$address->$item}" type="text" act="save_address">
</div>
{$item = 'level'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Level' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
		title="{l s='Level' mod='ecm_checkout'}" {$as[$item]['required']} placeholder="{l s='Level' mod='ecm_checkout'}"
        id="{$item}" name="{$item}" value="{$address->$item}" type="text" act="save_address">
</div>
{$item = 'door'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Door' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
		title="{l s='Door' mod='ecm_checkout'}" {$as[$item]['required']} placeholder="{l s='Door' mod='ecm_checkout'}"
        id="{$item}" name="{$item}" value="{$address->$item}" type="text" act="save_address">
</div>
{$item = 'intercom'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Intercom' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
		title="{l s='Intercom' mod='ecm_checkout'}" {$as[$item]['required']} placeholder="{l s='Intercom' mod='ecm_checkout'}"
        id="{$item}" name="{$item}" value="{$address->$item}" type="text" act="save_address">
</div>
{$item = 'elevator'}
<div class="form-row" {$as[$item]['unvisible']} >
	<span class="custom-checkbox">    
        ...
        {if $address->$item == 1} checked="checked" {/if}>
		<span><i class="material-icons rtl-no-flip checkbox-checked">&#xE5CA;</i></span>
		<label class="{$as[$item]['required']}-after" for="{$item}">{l s='Elevator' mod='ecm_checkout'}</label>
	</span>
</div>
{$item = 'concierge'}
<div class="form-row" {$as[$item]['unvisible']} >
	<span class="custom-checkbox">    
        ...
        {if $address->$item == 1} checked="checked" {/if}>
		<span><i class="material-icons rtl-no-flip checkbox-checked">&#xE5CA;</i></span>
		<label class="{$as[$item]['required']}-after" for="{$item}">{l s='Concierge' mod='ecm_checkout'}</label>
	</span>
</div>
{$item = 'zone'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Zone' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
		title="{l s='Zone' mod='ecm_checkout'}" {$as[$item]['required']} placeholder="{l s='Zone' mod='ecm_checkout'}"
        id="{$item}" name="{$item}" value="{$address->$item}" type="text" act="save_address">
</div>
{$item = 'zone_name'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Zone Name' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
		title="{l s='Zone Name' mod='ecm_checkout'}" {$as[$item]['required']} placeholder="{l s='Zone Name' mod='ecm_checkout'}"
        id="{$item}" name="{$item}" value="{$address->$item}" type="text" act="save_address">
</div>
{$item = 'lat'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='lat' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
		title="{l s='lat' mod='ecm_checkout'}" {$as[$item]['required']} placeholder="{l s='lat' mod='ecm_checkout'}"
        id="{$item}" name="{$item}" value="{$address->$item}" type="text" act="save_address">
</div>
{$item = 'lng'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='lng' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
		title="{l s='lng' mod='ecm_checkout'}" {$as[$item]['required']} placeholder="{l s='lng' mod='ecm_checkout'}"
        id="{$item}" name="{$item}" value="{$address->$item}" type="text" act="save_address">
</div>
{$item = 'valid_adr'}
<div class="form-row" {$as[$item]['unvisible']} >
	<span class="custom-checkbox">    
        ...
        {if $address->$item == 1} checked="checked" {/if}>
		<span><i class="material-icons rtl-no-flip checkbox-checked">&#xE5CA;</i></span>
		<label class="{$as[$item]['required']}-after" for="{$item}">{l s='valid_adr' mod='ecm_checkout'}</label>
	</span>
</div>
{$item = 'is_dm'}
<div class="form-row" {$as[$item]['unvisible']} >
	<span class="custom-checkbox">    
        ...
        {if $address->$item == 1} checked="checked" {/if}>
		<span><i class="material-icons rtl-no-flip checkbox-checked">&#xE5CA;</i></span>
		<label class="{$as[$item]['required']}-after" for="{$item}">{l s='is_dm' mod='ecm_checkout'}</label>
	</span>
</div>
<!-- Fozzy places -->
...
{$item = 'other'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Other' mod='ecm_checkout'}</label>
...
{$item = 'vat_number'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='Vat number' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
...
{$item = 'dni'}
<div class="form-row" {$as[$item]['unvisible']} >
        <label class="">{l s='DNI' mod='ecm_checkout'}</label>
        <input class="form-control customer_ontype" {$as[$item]['required_input']} {$as[$item]['unvisible']}
