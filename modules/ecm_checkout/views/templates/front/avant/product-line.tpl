...
<div class="product-line-grid">
  ...
  <div class="product-line-grid-right product-line-actions col-md-5 col-xs-12">
    <div class="row">
      <div class="col-xs-2 hidden-md-up"></div>
          ...
          <div class="col-md-6 col-xs-6 qty">
            ...
            {else}
              ...
              <span class="input-group-btn-vertical">
                ...
                onclick="action('quantity_up', '{$product.id_product|escape:'javascript'}_{$product.id_product_attribute|escape:'javascript'}')"
                >
                    <i class="material-icons touchspin-up"></i></button>
                <button class="btn btn-touchspin bootstrap-touchspin-down" type="button"
                onclick="action('quantity_down', '{$product.id_product|escape:'javascript'}_{$product.id_product_attribute|escape:'javascript'}')"
                >
