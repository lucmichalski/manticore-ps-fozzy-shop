...
<div class="row  to_login hidden">
	<div class="col-xs-12 col-sm-12">
		<span class="btn pull-right" title="{l s='Close window' mod='ecm_simcheck'}" onclick = "to_login()">
		<i class="icon-remove icon-1x"></i>
		</span>    
		<div class="box center">
		    ...
		    <p class="submit">
		        <button class="btn btn-info button-medium" onclick="login()">
		            <span>
