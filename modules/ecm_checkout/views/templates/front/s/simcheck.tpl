...
<!-- ecm_simplecheckout module -->
	{if $cart_qties == 0}
		<div class="row col-lg-12 col-xs-12">
			<p class="cart-grid-right alert alert-warning">{l s='Your shopping cart is empty.' mod='ecm_checkout'}</p>
		</div>
	{else}
	<div id="ecm_checkout">
		<div class="row col-lg-12 col-sm-12">
			<div class="cart-grid-right col-lg-12 col-xs-12">
				<span id="cart_place" class="card"></span>
