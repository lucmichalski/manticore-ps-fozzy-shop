...
--
-- Структура таблицы `ps_fozzy_sampling_small_clients`
--

DROP TABLE IF EXISTS `ps_fozzy_sampling_small_clients`;
CREATE TABLE `ps_fozzy_sampling_small_clients` (
...
--
-- Структура таблицы `ps_fozzy_sampling_small_products`
--

DROP TABLE IF EXISTS `ps_fozzy_sampling_small_products`;
CREATE TABLE `ps_fozzy_sampling_small_products` (
...
--
ALTER TABLE `ps_fozzy_sampling_small_clients`
  ADD PRIMARY KEY (`id_client_s`),
  ADD UNIQUE KEY `id_clients` (`id_client_s`),
  ADD KEY `id_client` (`id_client`);

--
-- Индексы таблицы `ps_fozzy_sampling_small_products`
--
ALTER TABLE `ps_fozzy_sampling_small_products`
