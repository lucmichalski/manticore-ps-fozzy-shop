...
<script type="text/template" id="tmpl-btn-edit-with-elementor-category">
    ...
    <div style="margin-bottom: 20px; border-bottom:  1px solid #cecece">
        <div class="form-group">
            <label class="control-label col-lg-3"><span>{l s='Show elementor content only' mod='iqitelementor'}</span></label>
            <div class="col-lg-9">
                        <span class="switch prestashop-switch fixed-width-lg">
																				<input type="radio" name="justElementor" id="justElementor_on" value="1"  {if $justElementorCategory}checked="checked"{/if}>
										<label for="justElementor_on">{l s='Yes' mod='iqitelementor'}</label>
																				<input type="radio" name="justElementor" id="justElementor_off" value="0"  {if !$justElementorCategory}checked="checked"{/if}>
										<label for="justElementor_off">{l s='No' mod='iqitelementor'}</label>
