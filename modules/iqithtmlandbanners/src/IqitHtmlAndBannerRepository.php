...
class IqitHtmlAndBannerRepository
{
    ...
    {
        $usableHooks = ['displayShops', 'displayShopsBefore', 'displayThanks', 'displayFooter', 'displayFooterBefore', 'displayFooterAFter', 'displayLeftColumn', 'displayRightColumn',  'displayWrapperTopInContainer', 'displayWrapperTop', 'displayNavCenter', 'displayWrapperBottom', 'displayWrapperBottomInContainer', 'displayMyAccountDashboard', 'displayReassurance', 'displayRightColumnProduct', 'displayNav1', 'displayNav2', 'displayProductAdditionalInfo'];
    ...
    {
        $usableHooks = ['displayShoppingCart', 'displayShops', 'displayShopsBefore', 'displayThanks', 'displayFooter', 'displayFooterBefore', 'displayFooterAFter', 'displayLeftColumn', 'displayRightColumn',   'displayWrapperTopInContainer', 'displayWrapperTop', 'displayWrapperBottom', 'displayWrapperBottomInContainer',  'displayMyAccountDashboard',  'displayReassurance', 'displayRightColumnProduct', 'displayBanner', 'displayProductAdditionalInfo'];
