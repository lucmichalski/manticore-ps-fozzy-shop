...
class cdc_googletagmanager extends Module
{
    ...
    public function dataLayerToJson($dataLayer) {
        ...
        if(count((array)$dataLayer)) {
            ...
            $dataLayerJs = str_replace("gtm_ee_event_category", "gtm-ee-event-category", $dataLayerJs);
            $dataLayerJs = str_replace("gtm_ee_event_action", "gtm-ee-event-action", $dataLayerJs);
            $dataLayerJs = str_replace("gtm_ee_event_non_interaction", "gtm-ee-event-non-interaction", $dataLayerJs);
	...
	protected function generateEnhancedEcommerceCart() {
        ...
        $actionField = new Gtm_ActionField();
        if ($this->context->controller->php_self == 'order') $step = 2; 
        $actionField->step = $step;
       // dump($this->context->controller->php_self);
       // die();
        //$this->dataLayer->event = "checkout";
        $this->dataLayer->event = 'gtm-ee-event';
        $this->dataLayer->gtm_ee_event_category = 'Enhanced Ecommerce';
        $this->dataLayer->gtm_ee_event_action = 'checkout';
        $this->dataLayer->gtm_ee_event_non_interaction = 'False';
    ...
    protected function generateEnhancedEcommerceHomepage() {
        ...
        $this->dataLayer->event = 'gtm-ee-event';
        $this->dataLayer->gtm_ee_event_category = 'Enhanced Ecommerce';
        $this->dataLayer->gtm_ee_event_action = 'homepage';
        $this->dataLayer->gtm_ee_event_non_interaction = 'False';
    ...
    protected function generateEnhancedEcommerceProductList($page) {
        ...
        $this->dataLayer->event = 'gtm-ee-event';
        $this->dataLayer->gtm_ee_event_category = 'Enhanced Ecommerce';
        $this->dataLayer->gtm_ee_event_action = 'impressions';
        $this->dataLayer->gtm_ee_event_non_interaction = 'False';
    }
    ...
    protected function generateEnhancedEcommerceProduct() {
        ...
        $this->dataLayer->event = 'gtm-ee-event';
        $this->dataLayer->gtm_ee_event_category = 'Enhanced Ecommerce';
        $this->dataLayer->gtm_ee_event_action = 'impression';
        $this->dataLayer->gtm_ee_event_non_interaction = 'False';
    }
        ...
        if(!empty($refundsQueue)) {
            ...
            if(is_array($ordersToRefund) && count($ordersToRefund)) {
              ...
              //  $this->dataLayer->event = "order_refund";
                $this->dataLayer->event = 'gtm-ee-event';
                $this->dataLayer->gtm_ee_event_category = 'Enhanced Ecommerce';
                $this->dataLayer->gtm_ee_event_action = 'order_refund';
                $this->dataLayer->gtm_ee_event_non_interaction = 'False';
                return true;
            }
        }
    ...
    protected function generateEnhancedEcommerceOrderResend() {
        ...
        if(!empty($cartsResendQueue)) {
            ...
            if(is_array($cartsToResend) && count($cartsToResend)) {
                ...
                $this->dataLayer->event = 'gtm-ee-event';
                $this->dataLayer->gtm_ee_event_category = 'Enhanced Ecommerce';
                $this->dataLayer->gtm_ee_event_action = 'order_resend';
                $this->dataLayer->gtm_ee_event_non_interaction = 'False';
                return true;
            }
        }
