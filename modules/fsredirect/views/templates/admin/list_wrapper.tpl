...
<br /><br />
<fieldset>
    <legend>{l s='URL Redirects' mod='fsredirect'}</legend>
    {/if}
    ...
    <a href="{$module_delete_all_url|escape:'html':'UTF-8'|fsrCorrectTheMess}" class="button"
       onclick="if (confirm('{l s='Are you sure you want to delete all URL Redirects?' mod='fsredirect'}')){literal}{return true;} else {return false;}{/literal}">
        {l s='Delete All URL Redirects' mod='fsredirect'}
    </a>
</fieldset>
<br /><br />
{/if}
