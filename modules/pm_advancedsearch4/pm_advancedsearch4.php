...
if (!Configuration::get('PS_DISABLE_OVERRIDES') && file_exists(_PS_ROOT_DIR_ . '/modules/pm_advancedsearch4/classes/As4SearchEngineOverride.php')) {
    include_once(_PS_ROOT_DIR_ . '/modules/pm_advancedsearch4/classes/As4SearchEngineOverride.php');
}
    ...
    public function setProductFilterContext()
    {
        ...
        if (As4SearchEngine::$productFilterListSource == 'best-sales') {
            ...
            if (As4SearchEngine::$productFilterListSource == 'search' && As4SearchEngine::$productFilterListData) {
                // если не отключены все переопределения и есть сам класс переопределения
                if (!Configuration::get('PS_DISABLE_OVERRIDES') && class_exists('As4SearchEngineOverride')) {
                    As4SearchEngineOverride::getProductsByNativeSearch(As4SearchEngineOverride::$productFilterListData);
                } else {
