...
class RevsliderPrestashop extends Module
{
    ...
    public static function revSliderShortcode($args)
    {
        ...
        if(_PS_VERSION_ < 1.7){
                                    ...
                                    $wpdb = rev_db_class::rev_db_instance();
                                    $sliderData = $wpdb->fetchSingle(RevSliderGlobals::$table_sliders, $wpdb->prepare("id = %s", array($slider_id)));
...
public static function loadAddonAssetsSpeicifically($params,$slider){
         if(isset($params->filmstrip_enabled)){
                            ...
                            if(isset($params['revealer_enabled']) && $params['revealer_enabled'] == 'true'){
                                    $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-revealer-addon/public/assets/css/revolution.addon.revealer.preloaders.css');
                                $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-revealer-addon/public/assets/css/revolution.addon.revealer.css');
                                    $this->context->controller->registerJavascript('addon-revealer', 'modules/'.$this->name.'/addons/revslider-revealer-addon/public/assets/js/revolution.addon.revealer.min.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                            }
                            if(isset($params['panorama_enabled']) && $params['panorama_enabled'] == 'true'){
                                    $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-panorama-addon/public/assets/css/revolution.addon.panorama.css');
                                $this->context->controller->registerJavascript('addon-panorama', 'modules/'.$this->name.'/addons/revslider-panorama-addon/public/assets/js/three.min.js', ['position' => 'bottom', 'priority' => 1500]); 
                                    $this->context->controller->registerJavascript('addon-panorama', 'modules/'.$this->name.'/addons/revslider-panorama-addon/public/assets/js/revolution.addon.panorama.min.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                            }
                             if(isset($params['duotonefilters_enabled']) && $params['duotonefilters_enabled'] == 'true'){
                                    $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-duotonefilters-addon/public/assets/css/revolution.addon.duotonefilters.css');
                                $this->context->controller->registerJavascript('addon-duotonefilters', 'modules/'.$this->name.'/addons/revslider-duotonefilters-addon/public/assets/js/revolution.addon.duotonefilters.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                             }
                            if(isset($params['bubblemorph_enabled']) && $params['bubblemorph_enabled'] == 'true'){
                                    $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-bubblemorph-addon/public/assets/css/revolution.addon.bubblemorph.css');
                                $this->context->controller->registerJavascript('addon-bubblemorph', 'modules/'.$this->name.'/addons/revslider-bubblemorph-addon/public/assets/js/revolution.addon.bubblemorph.min.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                            }
                            
                            if(isset($params['beforeafter_enabled']) && $params['beforeafter_enabled'] == 'true'){
                              //  die("fired");
                                $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-beforeafter-addon/public/assets/css/revolution.addon.beforeafter.css');
                                $this->context->controller->registerJavascript('addon-beforeafter', 'modules/'.$this->name.'/addons/revslider-beforeafter-addon/public/assets/js/revolution.addon.beforeafter.min.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                            }
                            if(isset($params['revslider-weather-enabled']) && $params['revslider-weather-enabled'] == 'true'){
                                 $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-weather-addon/public/assets/css/revslider-weather-addon-icon.css');
                                    $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-weather-addon/public/assets/css/revslider-weather-addon-public.css');
                                $this->context->controller->registerJavascript('addon-weather', 'modules/'.$this->name.'/addons/revslider-weather-addon/public/assets/js/revslider-weather-addon-public.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                            }
                            if(isset($params['revslider-refresh-enabled']) && $params['revslider-refresh-enabled'] == 'true'){
                                    $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-refresh-addon/public/assets/css/revslider-refresh-addon-public.css');
                                $this->context->controller->registerJavascript('addon-refresh', 'modules/'.$this->name.'/addons/revslider-refresh-addon/public/assets/js/revslider-refresh-addon-public.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                            }
                           if(isset($params['liquideffect_enabled']) && $params['liquideffect_enabled'] == 'true'){
                                    $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-liquideffect-addon/public/assets/css/liquideffect.css');
                                $this->context->controller->registerJavascript('addon-liquideffect-pixi', 'modules/'.$this->name.'/addons/revslider-liquideffect-addon/public/assets/js/pixi.min.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                                    $this->context->controller->registerJavascript('addon-liquideffect', 'modules/'.$this->name.'/addons/revslider-liquideffect-addon/public/assets/js/revolution.addon.liquideffect.min.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                            }
                            $addon_folder_name = "revslider-maintenance-addon/revslider-maintenance-addon.php";
                                if(get_option($addon_folder_name)=='active'){ 
                                    $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-maintenance-addon/public/assets/css/revslider-maintenance-addon-public.css');
                                $this->context->controller->registerJavascript('addon-maintenance', 'modules/'.$this->name.'/addons/revslider-maintenance-addon/public/assets/js/revslider-maintenance-addon-public.js', ['position' => 'bottom', 'priority' => 1500]);  
