...
class Novepopup extends Module
{
	...
	{
		if (Tools::isSubmit('submitNovepopupModule'))
			$this->_postProcess();
	...
	protected function renderForm()
	{
		...
		$helper->submit_action = 'submitNovepopupModule';
	...
	protected function _postProcess()
	{
		...
		$this->_clearCache('novepopup.tpl');
		$this->generateCss();
	}
	...
	public function generateCss()
	{
		...
		if (Configuration::get($this->config_name.'_newsletter'))
			$add_val = 95;
		$css .= '
		@media (max-width: '.((int)Configuration::get($this->config_name.'_width') + 40).'px) {#novepopup, #novepopup-overlay{ display: none !important;}} 
		@media (max-height: '.((int)Configuration::get($this->config_name.'_height') + 80).'px) {#novepopup, #novepopup-overlay{ display: none !important;}} 
		#novepopup{ width: '.(int)Configuration::get($this->config_name.'_width').'px; height: '.((int)Configuration::get($this->config_name.'_height') + $add_val).'px; }

		#novepopup .novepopup-content{ color: '.Configuration::get($this->config_name.'_txt_color').'; background-color: '.(Configuration::get($this->config_name.'_bg_color')).'; 
		...
		#novepopup .novepopup-newsletter-form{ color: '.Configuration::get($this->config_name.'_new_txt_color').'; background-color: '.(Configuration::get($this->config_name.'_new_bg_color')).'; 
		...
		#novepopup .novepopup-newsletter-form .newsletter-input{
		...
		#novepopup .novepopup-newsletter-form .newsletter-inputl:-moz-placeholder {
  color: '.Configuration::get($this->config_name.'_input_txt_color').' !important;}
#novepopup .novepopup-newsletter-form .newsletter-input::-moz-placeholder {
  color: '.Configuration::get($this->config_name.'_input_txt_color').' !important;}
#novepopup .novepopup-newsletter-form .newsletter-input:-ms-input-placeholder {
  color: '.Configuration::get($this->config_name.'_input_txt_color').' !important; }
#novepopup .novepopup-newsletter-form .newsletter-input::-webkit-input-placeholder {
  color: '.Configuration::get($this->config_name.'_input_txt_color').' !important; }

		#novepopup .novepopup-content{
		height: '.((int)Configuration::get($this->config_name.'_height')).'px;
		}
		';
		if (Shop::getContext() == Shop::CONTEXT_GROUP)
			$my_file = $this->local_path.'css/novepopup_g_'.(int)$this->context->shop->getContextShopGroupID().'.css';
		elseif (Shop::getContext() == Shop::CONTEXT_SHOP)
			$my_file = $this->local_path.'css/novepopup_s_'.(int)$this->context->shop->getContextShopID().'.css';
	...
	public function hookHeader()
	{
		...
		if (Shop::getContext() == Shop::CONTEXT_GROUP)
		$this->context->controller->addCSS(($this->_path).'css/novepopup_g_'.(int)$this->context->shop->getContextShopGroupID().'.css', 'all');
		elseif (Shop::getContext() == Shop::CONTEXT_SHOP)
		$this->context->controller->addCSS(($this->_path).'css/novepopup_s_'.(int)$this->context->shop->getContextShopID().'.css', 'all');
	}
	...
	public function hookfreeFblock()
	{
		...
		if (!isset($_COOKIE['novepopup_'.(int)Configuration::get($this->config_name.'_newval')]))
		{

		if (!$this->isCached('novepopup.tpl', $this->getCacheId()))
		{
		...
		Media::addJsDef(array('novepopup_time' => (int)Configuration::get($this->config_name.'_cookie')));
		Media::addJsDef(array('novepopup_name' => 'novepopup_'.(int)Configuration::get($this->config_name.'_newval')));
		return $this->display(__FILE__, 'novepopup.tpl', $this->getCacheId());
		}
		return false;
	}
}
