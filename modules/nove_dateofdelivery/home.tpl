...
<h2 style="color: white;text-align: center;margin: 12px 0;">{l s='Возможное время доставки' mod='nove_dateofdelivery'}:</h2>
{foreach from=$carrier_active item=carrier}
<h2 style="color: white;text-align: center;margin: 12px 0;">{$carrier.name}:</h2>
