...
class AdminSimpleBlogPostsController extends ModuleAdminController
{
    ...
    public function renderForm()
    {
        ...
        if (isset($obj->id)) {
            ...
            // $gallery_styles[] = array('value' => 'default', 'label' => 'Static (image after image)');
            // $gallery_styles[] = array('value' => 'slider', 'label' => 'Slider (BxSlider)');
            // $gallery_styles[] = array('value' => 'metro', 'label' => 'Metro (Windows like) gallery');
            // $gallery_styles[] = array('value' => 'masonry', 'label' => 'Masonry (Pinterest like) gallery');
