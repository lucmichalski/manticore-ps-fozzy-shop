...
<script type="text/javascript">
    var action_url='{$action_url|escape:'javascript':'UTF-8'}';
    var preview='0';
...
<span id="ooc_button" class="btn btn-primary btn-lg" onclick="show_ooc_window();">{l s='One click order' mod='orderinoneclick'}</span>
<!-- /MODULE Order in One Click -->
