...
{if $blockfaqfaq_right == 1}

	<div id="blockfaq_block_right"  class="block {if $blockfaqis17 == 1}block-categories hidden-sm-down{/if} {if $blockfaqis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if}">
