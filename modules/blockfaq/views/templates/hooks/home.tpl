...
{if $blockfaqis17 == 0}<div class="clear"></div>{/if}
{if $blockfaqfaq_home == 1}
<div {if $blockfaqis_ps15 == 1 && $blockfaqis17 == 0}id="left_column"{/if}>
	<div id="blockfaq_block_left"  class="block {if $blockfaqis17 == 1}block-categories{/if} {if $blockfaqis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if}">
		<h4 class="title_block {if $blockfaqis17 == 1}text-uppercase h6{/if}">
