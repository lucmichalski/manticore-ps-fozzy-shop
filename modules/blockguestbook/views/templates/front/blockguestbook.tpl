...
<div class="toolbar-top">
	...
	<div class="sortTools {if $blockguestbookis16 == 1}sortTools16{/if} margin-bottom-10">
		<ul class="actions">
			<li class="frst">
					<strong>{l s='Posts' mod='blockguestbook'}  ( <span id="count_items_top"  class="guestbook-count-items">{$count_all_reviews|escape:'htmlall':'UTF-8'}</span> )</strong>
			</li>
		</ul>
	</div>
			...
			<td class="info">
               ...
               <div class="clear"></div>
				<span class="foot_center margin-top-10">{l s='Posted by' mod='blockguestbook'} {$review.name|escape:'htmlall':'UTF-8' nofilter}</b>
                    ...
                    <br/><br/>
                    <span class="foot_center">{$review.date_add|date_format:"%d-%m-%Y"|escape:'htmlall':'UTF-8'}</span><br>
				<br>
...
<div class="text-align-center margin-bottom-20" id="add_guestbook">
    <input type="button" onclick="show_guestbook_form()" value="{l s='Add Guestbook Post' mod='blockguestbook'}" class="btn-custom btn-primary-blockguestbook guestbook-add-btn" />
</div>
...
<div id="add-guestbook-form">
	...
	<label for="name-review">{l s='Name' mod='blockguestbook'}:<span class="guestbook-req">*</span></label>
		...
		<div id="footer-add-blockguestbook-form-blockguestbook"  class="form-right block-add-guestbook-button">
                <input type="submit" name="submit_blockguestbook" value="{l s='Add Post' mod='blockguestbook'}" class="btn-custom btn-success-custom guestbook-add-btn" />
            </div>
