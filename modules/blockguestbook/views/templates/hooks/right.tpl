...
{if $blockguestbookg_right == 1}

	<div id="blockguestbook_block_right"  class="block blockmanufacturer {if $blockguestbookis17 == 1}block-categories hidden-sm-down{/if} ps15-color-background-g {if $blockguestbookis16 == 1}blockguestbook-block16{/if}">
