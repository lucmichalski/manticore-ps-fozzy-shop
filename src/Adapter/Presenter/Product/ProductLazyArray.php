...
class ProductLazyArray extends AbstractLazyArray
{
    ...
    private function addPriceInformation(
        ...
        //$this->product['test2'] = SpecificPrice::getQuantityDiscounts($product['id_product'], $id_shop, $id_currency, $id_country, $id_group);
        $this->product['price_collections'] = SpecificPrice::getQuantityDiscounts($this->product['id_product'], 1, 1, 216, 1);
